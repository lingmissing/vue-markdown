<template>
	<div class="left">
		...
		<button
			:disabled="!editable" 
			type="button" 
			v-if="toolbars.ul" @click="$clicks('ul')"
		...
		<button
			...
			<div class="op-image popup-dropdown" v-show="s_img_dropdown_open">
				<div 
					...
					title="ctrl+alt+l"><span>{{d_words.tl_image}}</span></div>
		...
		<button 
			type="button" 
			v-if="toolbars.undo" 
			@click="$clicks('undo')" class="op-icon fa fa-mavon-undo"
			aria-hidden="true" :title="`${d_words.tl_undo} (ctrl+z)`"></button>
		<button 
			type="button" 
			v-if="toolbars.redo" 
			@click="$clicks('redo')" class="op-icon fa fa-mavon-repeat"
			aria-hidden="true"
			:title="`${d_words.tl_redo} (ctrl+y)`"></button>
		<button 
			type="button" 
			v-if="toolbars.trash" 
			@click="$clicks('trash')" class="op-icon fa fa-mavon-trash-o"
			aria-hidden="true"
			:title="`${d_words.tl_trash} (ctrl+breakspace)`"></button>
		<button 
			type="button" 
			v-if="toolbars.save" 
			@click="$clicks('save')" class="op-icon fa fa-mavon-floppy-o"
			aria-hidden="true"
