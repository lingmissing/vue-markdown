<template>
	<div class="right">
		<button
			...
			@click="$clicks('navigation')" v-show="!s_navigation"
		...
		@click="$clicks('phone')" v-show="s_screen_phone && s_screen_phone_toggle"
		...
		<button
			...
			@click="$clicks('preview')" v-show="s_preview_switch"
						class="op-icon fa fa-mavon-eye-slash selected"
						aria-hidden="true" :title="`${d_words.tl_edit} (F9)`"></button>
		<button
			type="button" 
		...
		<button
			...
			@click="$clicks('read')" 
			class="op-icon fa fa-mavon-window-maximize" aria-hidden="true"
